...
namespace GalacticConquest.Launcher
{
	public partial class TestForm : Form
	{
		...
		public Process createSWBF2Process()
		{
			try {
				//Setup EasyHook
				Config.Register("GalacticConquestInject", "GalacticConquestInject.dll");
				...
				//Inject our DLL
				RemoteHooking.Inject(proc.Id, InjectionOptions.Default, "GalacticConquestInject.dll", "GalacticConquestInject.dll", "GalacticConquest");
